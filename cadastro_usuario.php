...
<div class="container" style="width: 400px; margin-top: 40px;">
  ...
  <form>
    ...
    <div class="form-group">
      <label>E-mail</label>
      <input type="text" name="emailusuario" class="form-control" required autocomplete="off" placeholder="Seu E-mail">
    </div>
    <div class="form-group">
      <label>Senha</label>
  ...
  <div style="text-align: right;">
    <button type="submit" class="btn btn-sm btn-success">Cadastro</button>
  </div>
  </form>
